...
func TestReconcile(t *testing.T) {
	...
	instance := &infrav1alpha1.Inventory{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Inventory object and expect the Reconcile and Deployment to be created
